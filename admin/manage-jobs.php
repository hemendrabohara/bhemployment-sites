...
$query = "SELECT j.*, (SELECT COUNT(*) FROM job_applications a WHERE a.job_id = j.id) as app_count FROM jobs j";
$params = [];

if (!empty($status_filter)) {
    $query .= " WHERE j.approval_status = :status";
                                        ...
                                        <tbody>
                                            <?php foreach ($jobs as $job): ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="view-application.php?job_id=<?php echo $job['id']; ?>" style="background: #0066cc; color: white; padding: 4px 10px; border-radius: 20px; text-decoration: none; font-size: 13px; font-weight: 600; display: inline-block;">
                                                            <?php echo $job['app_count']; ?> <i class="fas fa-users" style="margin-left: 3px;"></i>
                                                        </a>
                                                    </td>
                                                    <td>
