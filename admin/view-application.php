...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['application_id'], $_POST['status'])) {
    ...
    try {
        ...
        redirect('view-application.php?job_id=' . $job_id);
                                            ...
                                            <?php foreach ($applications as $application): ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <?php else: ?>
                                                            <span class="badge badge-secondary" style="font-size: 11px; padding: 4px 8px; background: #e0e0e0; color: #555; border-radius: 4px;">Quick Apply</span>
                                                        <?php endif; ?>
                                                    </td>
