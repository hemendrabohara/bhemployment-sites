...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_POST['toggle_verification'])) {
        // Fix the toggle logic: If is_verified is 1, set to 0; if 0 or empty, set to 1
        $is_verified = (isset($_POST['is_verified']) && $_POST['is_verified'] == '1') ? 0 : 1;
        $verification_notes = sanitizeInput($_POST['verification_notes'] ?? '');
        
        // Add debug logging
        error_log("ADMIN VERIFICATION DEBUG - User ID: {$user_id}, Setting verified to: {$is_verified}, Raw POST data: " . json_encode($_POST));
        ...
        try {
            ...
            // Debug database impact
            error_log("ADMIN VERIFICATION DEBUG - Database update completed. Rows affected: " . $stmt->rowCount());
            ...
            // Debug user data after update
            error_log("ADMIN VERIFICATION DEBUG - Updated user data: " . json_encode([
                'id' => $user['id'],
                'email' => $user['email'],
...
<body>
                    ...
                    <div class="content-box">
                        ...
                        <div class="content-body">
                            ...
                            <form action="manage-users.php" method="POST">
                                ...
                                <input type="hidden" name="is_verified" value="<?php echo $verification_user['is_verified'] ? '1' : '0'; ?>">
    ...
    <script>
        ...
        function showVerificationModal(userId, userName, userEmail, isVerified) {
            ...
            // Store whether the user is currently verified - use string representation of boolean
            modalIsVerified.value = isVerified ? '1' : '0';
