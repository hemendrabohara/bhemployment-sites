...
// Add debug logging
error_log("VERIFICATION PENDING DEBUG - Session data: " . json_encode([
    'is_logged_in' => isLoggedIn(), 
    'session_verification' => $_SESSION['is_verified'] ?? 'not set',
    'session_verification_type' => isset($_SESSION['is_verified']) ? gettype($_SESSION['is_verified']) : 'N/A'
]));
...
elseif (isJobSeeker() && isVerified()) {
    // Add debug message to see how isVerified() evaluates
    error_log("VERIFICATION PENDING DEBUG - User verified check passed, redirecting to dashboard");
