        ...
        <div class="container">
            <div class="hero-grid">
                ...
                <div class="hero-image-side">
                    <picture>
                        <source srcset="<?php echo !empty($site_settings['hero_image']) ? str_replace(['.jpeg', '.jpg', '.png'], '.webp', $site_settings['hero_image']) : 'images/hero.webp'; ?>" type="image/webp">
                        <img src="<?php echo !empty($site_settings['hero_image']) ? $site_settings['hero_image'] : 'images/hero.jpeg'; ?>" alt="Nepali and Hindi-Speaking Nannies, Housekeepers, and Cooks in NYC" class="hero-main-img" width="882" height="504">
                    </picture>
                </div>
            </div>
        </div>
        ...
        <div class="container" style="max-width: 1200px;">
            <div style="display: flex; flex-wrap: wrap; justify-content: center; align-items: flex-start; gap: 40px;">
                <div class="trust-item">
                    <div class="trust-icon-circle" style="background-color: #4CAF50;">7+</div>
    ...
    <div class="container" style="max-width: 1000px; margin: 0 auto; padding: 0 20px;">
        <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 40px;">
            ...
            <div style="background: #f8fafc; border-radius: 16px; padding: 50px 40px; text-align: center; border: 1px solid #e2e8f0; transition: transform 0.3s ease; box-shadow: 0 4px 6px -1px rgba(0,0,0,0.05);" onmouseover="this.style.transform='translateY(-5px)'" onmouseout="this.style.transform='translateY(0)'">
                ...
                <a href="https://bhemployment.com/jobs" style="display: inline-block; background-color: #10b981; color: white; padding: 14px 30px; border-radius: 50px; text-decoration: none; font-weight: 600; transition: all 0.2s ease; box-shadow: 0 4px 6px rgba(16, 185, 129, 0.2);">Browse Job Listings</a>
            </div>
        </div>
    </div>
</section>
...
<section id="cta-banner" style="padding: 60px 0; background: linear-gradient(135deg, #0066cc, #003366); text-align: center; color: white;">
    <div class="container" style="max-width: 900px; margin: 0 auto; padding: 0 20px;">
        ...
        <div style="display: flex; justify-content: center; gap: 20px; flex-wrap: wrap;">
            <a href="tel:9293856177" style="display: inline-block; padding: 14px 30px; border-radius: 50px; background-color: #10b981; color: white; text-decoration: none; font-weight: 600; font-size: 16px; box-shadow: 0 4px 10px rgba(0,0,0,0.2); transition: transform 0.2s;"><i class="fas fa-phone-alt" style="margin-right: 8px;"></i> Call Us: (929) 385-6177</a>
    ...
    <div class="container" style="max-width: 1000px; margin: 0 auto; padding: 0 20px;">
        <div style="display: flex; flex-wrap: wrap; gap: 40px; align-items: center;">
            <div style="flex: 1; min-width: 300px;">
                <img src="/images/about.png" alt="B&H Employment & Consultancy Office" width="600" height="400" style="width: 100%; border-radius: 16px; box-shadow: 0 10px 20px rgba(0,0,0,0.1);">
            </div>
            <div style="flex: 1; min-width: 300px;">
                ...
                <div class="blog-preview-grid">
                    ...
                    <div class="blog-preview-card">
                        ...
                        <div class="blog-preview-text">
                            ...
                            <a href="blog-post.php?slug=<?php echo urlencode($post['slug']); ?>" class="read-more-link">Read More <i class="fas fa-long-arrow-alt-right"></i></a>
                        </div>
                    </div>
                    <?php 
                    $blog_counter++;
