    ...
    try {
        ...
        switch ($action) {
            case 'activate':
                ...
                $stmt->bindParam(':job_id', $job_id);
                $stmt->execute();
                flashMessage("Job status updated successfully", "success");
            ...
            <div class="dashboard-container">
                ...
                <div class="dashboard-content">
                    ...
                    <div class="content-header-actions">
                        ...
                        <a href="../submit-job.php" class="btn-primary"><i class="fas fa-plus"></i> Post New Job</a>
                    </div>
                    ...
                    <?php if (empty($jobs)): ?>
                        <div class="empty-state">
                            ...
                            <a href="../submit-job.php" class="btn-primary">Post a Job</a>
                        </div>
                    <?php else: ?>
                                ...
                                <tbody>
                                    <?php foreach ($jobs as $job): ?>
                                        <tr>
                                            ...
                                            <td>
                                                <span class="status-badge <?php echo strtolower($job['approval_status']); ?>">
                                                    <?php echo ucfirst($job['approval_status']); ?>
                                                </span>
                                            </td>
                                            <td class="actions">
                                                <a href="../job-details.php?id=<?php echo $job['id']; ?>" class="action-btn view" title="View Job" target="_blank">
                                                    <i class="fas fa-eye"></i>
                                                </a>
                                                
                                                <a href="my-job-applications.php?job_id=<?php echo $job['id']; ?>" class="action-btn view" title="View Applications" style="background-color: #0066cc; color: white;">
